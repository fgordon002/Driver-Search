...
@st.cache_data
def load_data():
    max_scores = pd.read_csv("/Users/finleygordon/Desktop/Lab/Driver_search/Data/Maxscores_alldrivers_allneurons.csv", index_col=0)
    neuron_metadata = pd.read_csv("/Users/finleygordon/Desktop/Lab/Driver_search/Data/neuron_metadata.csv", index_col=0)
    driver_metadata = pd.read_csv("/Users/finleygordon/Desktop/Lab/Driver_search/Data/driver_metadata.csv", index_col=0)
